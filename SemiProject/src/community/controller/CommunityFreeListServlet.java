 ...
 */
@WebServlet("/free.bo")
public class CommunityFreeListServlet extends HttpServlet {
   
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CommunityFreeListServlet() {
        super();
...
//자유게시판 리스트 뿌려주기
   ...
   ArrayList<Community> list = cService.selectList(currentPage,limit,category);
       ...
       RequestDispatcher view = null;
          ...
          view = request.getRequestDispatcher("views/community/freeListView.jsp");
