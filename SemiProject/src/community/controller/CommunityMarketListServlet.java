 ...
 */
@WebServlet("/market.bo")
public class CommunityMarketListServlet extends HttpServlet {
   
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CommunityMarketListServlet() {
        super();
   ...
   //1_2.공지사항 리스트 뿌려주기
   ArrayList<Community> list = cService.selectList(currentPage,limit,category);
