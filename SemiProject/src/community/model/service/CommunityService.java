...
public class CommunityService {
   ...
   public static ArrayList selectcList(int currentPage, int limit,int userNo) {
      ...
      public int getListCount(String category) {
            ...
            int listCount = new CommunityDao().getListCount(conn, category);
            
            close(conn);
            return listCount;
      }

      public ArrayList selectList(int currentPage, int limit, String category) {
         Connection conn = getConnection();
         ArrayList list = new CommunityDao().selectList(conn,currentPage,limit,category);
         close(conn);
         return list;
      }
   ...
   /* --------------------------------------------------------------------------------------------------------------*/
      ...
      public ArrayList<Community> freeSearchList(String selectbox, String searchbox) {
           Connection conn =getConnection();
            ArrayList list = new CommunityDao().freeSearchList(conn, selectbox, searchbox);
            close(conn);
            
            return list;
      }

      public ArrayList<Community> questionSearchList(String selectbox, String searchbox, String category) {
           Connection conn =getConnection();
            ArrayList list = new CommunityDao().questionSearchList(conn, selectbox, searchbox,category);
            close(conn);
            
            return list;
      }

      public ArrayList<Community> marketSearchList(String selectbox, String searchbox, String category) {
           Connection conn =getConnection();
            ArrayList list = new CommunityDao().marketSearchList(conn, selectbox, searchbox,category);
            close(conn);
