...
import safeInfo.model.vo.Pagination;
import safeInfo.model.vo.Safe;

/**
 * Servlet implementation class SafeListServlet
 */
@WebServlet("/list.si")
public class SafeListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SafeListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//1_2.공지사항 리스트 뿌려주기
		ArrayList<Safe> list = sService.selectList(currentPage,limit);
		...
		view = request.getRequestDispatcher("views/safeInfo/safeListView.jsp");
